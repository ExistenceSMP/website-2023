...
<MediaSection media={<ScreenshotCarousel />}>
    <div style={{display: 'flex', flexDirection: 'column', gap: '1em 0', justifyContent: 'space-between', height: '100%'}}>
        <main style={{margin: 0, marginTop: '1em', flexGrow: '2'}}>
            ...
            \
            Originally a content-creation-focused Minecraft SMP, we're now on our second Community Server, focusing on building a more open Minecraft community.
...
<MediaSection media={<YouTubeVideo id="nuOSlzNgzx4" />} reverse>
    <div style={{display: 'flex', flexDirection: 'column', height: '100%'}}>
        <main style={{margin: 0, marginTop: '1em', flexGrow: '1'}}>
            ...
            \
            Check out the trailer or visit the [Community](/community) page for more info!
